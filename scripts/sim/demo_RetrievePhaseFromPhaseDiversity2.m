%%
% File: demo_RetrievePhaseFromPhaseDiversity2.m
...
%		The idea is to get 0.3lambda astigmatism, 0.5Trefoil -0.4Coma
%
...
% The final result may contain some additional information, but this can be improve by making the tolFun smaller or using this first result as seed.
